        ...
        <section className="flex-grow">
            <div className="relative ">
                ...
                <div className="relative w-full h-full bg-black/30 bg-gradient-to-b from-black to-transparent to-50%">
                    <div className="h-full m-auto px-4 py-8 flex flex-col justify-center items-center md:w-11/12 lg:w-3/4 gap-2 ">
            ...
            <div className="md:w-11/12 lg:w-3/4 m-auto p-4 lg:py-8">
