...
const Footer = () => {
    return (
        <footer className="bg-black w-full h-14 md:h-16 lg:h-20 flex justify-center items-center overflow-hidden">
            ...
            <Link className="text-white flex items-center justify-center text-lg w-full h-full rounded-sm font-semibold md:hidden" to="/create-video">Nuevo Video</Link>
        </footer>
    )
}
